...
| 22 | Names need more variation; assigned JSON has repeats + real-athlete names | 🟠 | NameData expanded (60 nationalities, MCO/KEN added). The real-name-collision audit of the assigned JSON is still pending. **Noted during #30 (S37.20):** Championships.gd also has real-name/IP exposure outside campus scope — "IndyCar-equivalent"/"Indy NXT equivalent" descriptions and team-name lists containing real surnames (e.g. "Andretti Collective"). Fold into this audit. |
