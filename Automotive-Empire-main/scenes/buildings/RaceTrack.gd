...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Race Track", {})
	var lbl_title = Label.new()
	lbl_title.text = "🔴 RACE TRACK  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Full FIA-spec road circuit. Improves GP, EPC and Touring Car stats. Generates income via Public Racing Club."
