...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Academy", {})
	var lbl_title = Label.new()
	lbl_title.text = "🎓 ACADEMY  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Young driver development program. Generates junior talent at reduced cost each season."
