...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Oval Track", {})
	var lbl_title = Label.new()
	lbl_title.text = "🟡 OVAL TRACK  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "High-speed banked oval. Improves Stock Car and Open-Wheel stats. Generates income via Public Racing Club."
