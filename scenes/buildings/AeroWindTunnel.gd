...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Aerodynamic Wind Tunnel", {})
	var lbl_title = Label.new()
	lbl_title.text = "💨 AERODYNAMIC WIND TUNNEL  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Validates and optimizes aerodynamic car parts. Provides a permanent aero efficiency bonus to all cars."
