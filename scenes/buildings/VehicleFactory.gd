...
func _build_ui() -> void:
	...
	lbl_title.text = "🏭 VEHICLE ASSEMBLY FACTORY  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Automated consumer car production line. Generates significant commercial sales revenue. Future system."
