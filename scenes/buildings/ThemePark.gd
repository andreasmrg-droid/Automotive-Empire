...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Theme Park", {})
	var lbl_title = Label.new()
	lbl_title.text = "🎡 THEME PARK  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Major entertainment complex generating passive income. Acts as a marketability buffer during poor race results."
