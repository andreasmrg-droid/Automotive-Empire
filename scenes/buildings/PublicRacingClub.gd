...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Public Racing Club", {})
	var lbl_title = Label.new()
	lbl_title.text = "🏁 PUBLIC RACING CLUB  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Open track-day facility for paying amateurs. Income driven by team reputation."
