...
func _build_ui() -> void:
	...
	var building = GameState.campus_buildings.get("Merchandise Store", {})
	var lbl_title = Label.new()
	lbl_title.text = "👕 MERCHANDISE STORE  ·  Level %d" % building.get("level", 1)
	...
	lbl_desc.text = "Team merchandise shop. Income scales with team reputation and marketability."
